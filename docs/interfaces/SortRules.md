...
[config/types/sorting.ts:31](https://github.com/daidodo/format-imports/blob/9a1951d/src/lib/config/types/sorting.ts#L31)
...
[config/types/sorting.ts:25](https://github.com/daidodo/format-imports/blob/9a1951d/src/lib/config/types/sorting.ts#L25)
