...
Defined in: [config/types/sorting.ts:31](https://github.com/daidodo/format-imports/blob/30cacaa/src/lib/config/types/sorting.ts#L31)
...
Defined in: [config/types/sorting.ts:25](https://github.com/daidodo/format-imports/blob/30cacaa/src/lib/config/types/sorting.ts#L25)
