...
Defined in: [config/types/sorting.ts:31](https://github.com/daidodo/format-imports/blob/3225846/src/lib/config/types/sorting.ts#L31)
...
Defined in: [config/types/sorting.ts:25](https://github.com/daidodo/format-imports/blob/3225846/src/lib/config/types/sorting.ts#L25)
