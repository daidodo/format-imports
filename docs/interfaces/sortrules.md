...
[config/types/sorting.ts:31](https://github.com/daidodo/format-imports/blob/b5201ab/src/lib/config/types/sorting.ts#L31)
...
[config/types/sorting.ts:25](https://github.com/daidodo/format-imports/blob/b5201ab/src/lib/config/types/sorting.ts#L25)
