...
Defined in: [config/types/wrapping.ts:5](https://github.com/daidodo/format-imports/blob/e966d7c/src/lib/config/types/wrapping.ts#L5)
...
Defined in: [config/types/wrapping.ts:10](https://github.com/daidodo/format-imports/blob/e966d7c/src/lib/config/types/wrapping.ts#L10)
...
Defined in: [config/types/wrapping.ts:14](https://github.com/daidodo/format-imports/blob/e966d7c/src/lib/config/types/wrapping.ts#L14)
...
Defined in: [config/types/wrapping.ts:18](https://github.com/daidodo/format-imports/blob/e966d7c/src/lib/config/types/wrapping.ts#L18)
